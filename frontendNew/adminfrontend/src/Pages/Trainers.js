...
const Trainers = () => {
    ...
    const addTrainer = () => {
        console.log(tfname ,tlname, tpassword, tage, tmobile,tgender,tjoindate, temail);
    ...
    return (
        <div className="container">   
         <br />     
            ...
            <Button onClick={() => setLgShow(true)} Style={
      ...
      <div className="content-bottom">
                ...
                <div className="field-group">
						...
						<div className="wthree-field">
							<input type="text" name="tfname"  placeholder="First Name" required   
              autoComplete="off"
              onChange={(e) => { 
                  setTfname(e.target.value);
                    ...
                    <div className="field-group">
						<span aria-hidden="true"><AccountCircleIcon></AccountCircleIcon></span>
						<div className="wthree-field">
							<input type="text" name="tlname" placeholder="Last Name" required  
              autoComplete="off"
              onChange={(e) => { 
                  setTlname(e.target.value);
                    ...
                    <div className="field-group">
						...
						<div className="wthree-field">
							<input type="number" name="tage" placeholder="Age" required 
              autoComplete="off"
              onChange={(e) => { 
                setTage(e.target.value);
					...
					<div className="field-group">
						...
						<div className="wthree-field">
							<input type="text" name="tgender" placeholder="Gender" id="gender"
              autoComplete="off"
              onChange={(e) => { setTgender(e.target.value);}}/>
                    ...
                    <div className="field-group">
						...
						<div className="wthree-field">
							<input type="text" name="tmobile" placeholder="Mobile Number"  id="mobile"
                            autoComplete="off"
                            onChange={(e) => { 
                    ...
                    <div className="field-group">
						...
						<div className="wthree-field">
							<input type="text" name="taddress" placeholder="Address"  
                            autoComplete="off"
                            onChange={(e) => { 
                    ...
                    <div className="field-group">
						...
						<div className="wthree-field">
							<input type="email" name="temail" placeholder="Email Id"  
                            autoComplete="off"
                            onChange={(e) => { 
                    ...
                    <div className="field-group">
						...
						<div className="wthree-field">
							<input type="date" name="tjoindate" placeholder="Join Date"  id="date"
                            autoComplete="off"
                            onChange={(e) => { 
            ...
            <div className="field-group">
                       ...
                       <select name="Plan" onChange={setPlanId}  >
                            ...
                            {planList.map((plan)=>{
                        return ( <option value = {plan.pid}> {plan.pname} {plan.pid}
          ...
          <div className="field-group">
               ...
               onChange={(e) => { 
                 setImage(e.target.files[0]);
					...
					<div className="wthree-field">
					<Button onClick={addTrainer} className="btn" >Add</Button>
					</div>
					</form></div></Card>
        </Modal.Body>
      </Modal>
